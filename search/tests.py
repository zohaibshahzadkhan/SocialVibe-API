...
class SearchViewTests(TestCase):
    def setUp(self):
        ...
        # Create posts
        self.post1 = Post.objects.create(body='Public post about dogs', created_by=self.user1)
        self.post2 = Post.objects.create(body='Private post about cats', created_by=self.user1, is_private=True)
        self.post3 = Post.objects.create(body='Public post about birds', created_by=self.user2)
    ...
    def test_search(self):
        ...
        self.assertFalse(any(post['body'] == 'Private post about cats' for post in posts))
        self.assertFalse(any(post['body'] == 'Public post about birds' for post in posts))
